...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_UpgradeDialog_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_UpgradeDialog_t qt_meta_stringdata_UpgradeDialog = {
    {
        QT_MOC_LITERAL(0, 13)   // "UpgradeDialog"
    },
    "UpgradeDialog"
};
...
Q_CONSTINIT static const uint qt_meta_data_UpgradeDialog[] = {
...
Q_CONSTINIT const QMetaObject UpgradeDialog::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_UpgradeDialog.offsetsAndSizes,
    qt_meta_data_UpgradeDialog,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_UpgradeDialog_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<UpgradeDialog, std::true_type>
    >,
    nullptr
} };
